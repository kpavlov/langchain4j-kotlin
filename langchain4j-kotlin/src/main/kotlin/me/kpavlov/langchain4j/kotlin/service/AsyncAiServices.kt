...
public class AsyncAiServices<T : Any>(context: AiServiceContext) : AiServices<T>(context) {
    ...
    override fun build(): T {
        ...
        if (!context.hasChatMemory() && ChatMemoryAccess::class.java.isAssignableFrom(context.aiServiceClass)) {
        ...
        for (method in context.aiServiceClass.methods) {
            ...
            if (method.returnType in arrayOf(
